    ...
    return BaseController.extend(
      'mycompany.myapp.MyWorklistApp.controller.Worklist',
      {
        ...
        onInit: function () {
          ...
          this.setModel(this.getOwnerComponent().getModel(), 'ImportDocuments')
      ...
      if (iTotalItems && oTable.getBinding("items").isLengthFinal()) {
        ...
        this.getModel().read("/ImportDocuments/$count", {
      ...
      this.getModel("worklistView").setProperty("/worklistTableTitle", sTitle);  */
        ...
        onSearch: function (oEvent) {
          if (oEvent.getParameters().refreshButtonPressed) {
            ...
            if (sQuery && sQuery.length > 0) {
              aTableSearchState = [
                new Filter('ImportDocument', FilterOperator.Contains, sQuery)
              ]
            }
        ...
        onFramePress: function () {

            this.getRouter().getTargets().display("frame");

/*           if (Core.byId("idCompContainerDocflow") !== undefined) {
            Core.byId("idCompContainerDocflow").destroy();
          }
          var oComponentContainer = new sap.ui.core.ComponentContainer("idCompContainerDocflow", {
            name: "sap.ui.demo.cart",
            component: "sap.ui.demo.cart.Component",
            manifest: false,
            height: "100%",
            async: true

          });
          this.getView().byId("vboxTeste").addItem(oComponentContainer); */
        },
        ...
        _showObject: function (oItem) {
          this.getRouter().navTo('object', {
            objectId: oItem.getBindingContext('ImportDocuments').getObject()
              .DocumentId
          })
        },
